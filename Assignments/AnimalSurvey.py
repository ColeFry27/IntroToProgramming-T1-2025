...
traits = input("What is a trait of " + animal + "?\n> ")
...
print(animal_again + ", it is " + traits + ", it is a " + consumes + ", lives in" + where + ".") 
print("The " + animal + "is the color " + color + ", you like the " + animal + " because of " + response + ".")
print("The " + animal + "has the special feature of " + special_feature + ", and it lives on " + land_water + ".")
