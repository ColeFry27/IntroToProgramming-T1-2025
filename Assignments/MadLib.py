...
def mad_lib(nl, nr, pn, nm, en):
    print("Long ago, in " + nl + " there was a " + nr + " that ruled over all " + pn + ". Then came " + nm + " who was the only force capable of beating " + nr + " in the end " + en + " prevailed.")